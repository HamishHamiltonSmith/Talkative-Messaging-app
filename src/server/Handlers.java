...
public class Handlers {
    ...
    public void DELETE(String chatName){
        try {
            ...
            for (int x = 0; x<users.length; x++){
                ...
                File person = new File("/home/kali/Talkative/Users/" + users[x] + "/user_chats.txt");
    ...
    public void FETCH(String params){
        try {
            if (params.replace("\n", "").replace(" ","").equals("*")){
                ...
                File f = new File("/home/kali/Talkative/Users");
                String[] x = f.list();
                String result = "";
    ...
    public void CREATE(String chatName,String[] Users){
        ...
        String PATH = "/home/kali/Talkative/Chats/" + chatName;
        ...
        try {
            ...
            for (int x = 0; x<Users.length; x++){
                try {
                    ...
                    userPath = "/home/kali/Talkative/Users/" + Users[x].replace("\n","") + "/user_chats.txt";
